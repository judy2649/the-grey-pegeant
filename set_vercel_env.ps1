...
foreach ($name in $envVars.Keys) {
    ...
    $process = echo $value | npx -y vercel env add $name production
...
Write-Host "⚠️  Note: FIREBASE_SERVICE_ACCOUNT is still required for the dashboard." -ForegroundColor Yellow
